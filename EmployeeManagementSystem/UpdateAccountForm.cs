...
namespace EmployeeManagementSystem
{
    public partial class UpdateAccountForm : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Email have to format @gmail.com!", "Nofication", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            else
            {
                ...
                acc.password = Hashpassword(txtpassword.Text.Trim());
